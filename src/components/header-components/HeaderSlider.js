...
const HeaderSlider = () => {
  return (
    <div>
      <div className="background-image container mx-auto px-4 flex flex-col-reverse justify-between md:flex-row items-center mt-3 pt-5 md:pb-20 mb-16 text-center md:text-left">
        <div>
