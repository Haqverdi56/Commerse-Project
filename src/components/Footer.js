        ...
        <div className="background-footer">
            <div className="flex md:flex-row flex-col text-white pr-0 pl-0 mt-12 pb-12 justify-around md:mb-8 md:items-start items-center">
                ...
                <div className="text-center md:text-left">
                    <p className="mt-6 md:mb-5 mb-8">Menu</p>
                ...
                <div className="text-center md:text-left">
                    ...
                    <ul className="list-none">
                        <li className="flex items-center mb-3"><IoLocation className="mr-2"/> <a href="">M. K. Ataturk
                            avenue 89, Baku, Azerbaijan</a></li>
                        <li className="flex items-center mb-3"><IoMail className="mr-2"/> <a
                            href="">example@gmail.com</a></li>
                        <li className="flex items-center mb-3"><AiFillPhone className="mr-2"/> <a href="">*2108</a></li>
                    </ul>
                </div>
            </div>
            <div className="bg-white border border-white h-0.1 w-full hidden md:inline-block "></div>
            <div className="flex p-6 text-white md:flex-row flex-col-reverse justify-between items-center">
